...
namespace RingCentralDataIntegration
{
    internal class HttpRestClient
    {
        ...
        //internal static DataTable RequestReportDT(string clientId, string reportUri, bool insertIntoDatabase = true)
        //{
        ...
        //    var dobj = JsonConvert.DeserializeObject<dynamic>("asdf");
        ...
        //    var test = JObject.Parse(response.Content);

        //    var t = test["records"].Count();

        //    //JObject tes = test["records"];

        //    var te = test.Properties().Select(p => p.Name).ToList();

        //    //var testt = test["records"].

        //    foreach (var record in te)
        //    {
        //        var one = record;
        //    }

        //    //var test2 = test.records;

        //    //var te = test2.First;

        //    //var c = te.First.Count;
        ...
        //    //foreach (var record in test2.First.ChildTokens)
        //    //{
        //    //    var t = record.name;
        //    //}

        //    //List<> data = JsonConvert.DeserializeObject(response.Content);
        ...
        internal static XmlDocument RequestReportByExtension(string clientId, string reportUri, int numberOfExtensions)
        {
            ...
            for (var i = 0; i < numIterations; i++)
            {
                ...
                var extTblIndex = ds.Tables.IndexOf("extension"); // TODO: FIX TO BE UNIVERSAL (EXTENSION IS SPECIFIC TO THE EXTENSIONS)
                if (extTblIndex == -1)
